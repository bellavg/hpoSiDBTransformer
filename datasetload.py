...
train_inputs, train_labels, tv_inputs,  tv_labels = train_test_split(inputs, labels, test_size=0.4, random_state=42)
...
test_inputs, test_labels, valid_inputs,  valid_labels = train_test_split(tv_inputs, tv_labels, test_size=0.5, random_state=42)
