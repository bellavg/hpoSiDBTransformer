...
def objective(trial: optuna.trial.Trial):
    logger = CSVLogger(version="trial"+str(trial.number), save_dir="/home/igardner/hpologsnew4", name="hpotrials")
    ...
    trainer = pl.Trainer(max_epochs=10,strategy='ddp_find_unused_parameters_true',  logger=logger,  enable_checkpointing=False, enable_progress_bar=False,
                         check_val_every_n_epoch=10, limit_val_batches=10, limit_train_batches=50)
...
if __name__ == "__main__":
    ...
    study.optimize(objective, n_trials=10, timeout=3600, gc_after_trial=True)
    trials_df = study.trials_dataframe()
    trials_df.to_csv("/home/igardner/hpologsnew4/hpotrials.csv")
    ...
    fig.write_image("/home/igardner/hpologsnew4/optimization_plot.png")
